...
public class ToDoList extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        }catch (Exception e){Log.e("showerror",Log.getStackTraceString(e));}
    }
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setTask(String task) {
            ...
            taskTectView.setText(task);}catch (Exception e){Log.e("showerror",Log.getStackTraceString(e));}
        }

        public void setDesc(String desc) {
            try {
            TextView descTectView = mView.findViewById(R.id.descriptionTv);
            descTectView.setText(desc);}catch (Exception e){Log.e("showerror",Log.getStackTraceString(e));}
        }
                    ...
                    reference.child(key).setValue(model).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if (task.isSuccessful()) {
                                Toast.makeText(ToDoList.this, "Data has been updated successfully", Toast.LENGTH_SHORT).show();
                            } else {
